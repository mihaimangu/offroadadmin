...
const AboutPage = () => {
    return (
        <div className="about-page__wrapper">
            ...
            <p>masinideteren.ro este o platforma care isi propune sa adune anunturi de masini offroad din Romania si sa le afiseze, in beneficiul celor care sunt interesati de astfel de masini.</p>
